...
urlpatterns = [
    ...
    path('operacoes/<int:id>/cotacao-frete/', views_logistica.operacao_cotacao_frete, name='operacao_cotacao_frete'),
    path('operacoes/<int:id>/confirmar-coleta/', views_logistica.operacao_confirmar_coleta, name='operacao_confirmar_coleta'),
    path('operacoes/<int:id>/guia-transporte/', views_logistica.operacao_guia_transporte, name='operacao_guia_transporte'),
